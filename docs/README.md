...
| [`output-style.md`](output-style.md) | See the contract every failure/warning message follows (`✗ what: why` + `💡 hint`), what's frozen (JSON payloads, exit codes), and the checklist for adding new output. |
